...
class AddScreen extends StatelessWidget {
  AddScreen({required this.category_name});
    ...
    return BlocConsumer<MainCubit, MainStates>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(  iconTheme: IconThemeData(color: Colors.cyan),
                            ...
                            builder: ( context)=> Center(
                              child: defaultMaterialButton(function: () {
                                if (formKey.currentState!.validate()) {
                                    print(category_name);
                                  MainCubit.get(context).uploadImage(name: nameController.text,category:category_name!);
